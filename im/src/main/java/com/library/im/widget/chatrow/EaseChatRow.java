...
import com.library.im.adapter.EaseMessageAdapter;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    protected RecycleTextView usernickView;
    ...
    private void initView() {
        ...
        usernickView = (RecycleTextView) findViewById(R.id.tv_userid);
...
//            UserUtils.setUserNick(EMChatManager.getInstance().getCurrentUser(), usernickView);
            //usernickView.setText(PreferenceManager.getInstance().getCurrentUserNick());

            //使用Hawk，放在了app中
            GlideUtil.loadPicture(PreferenceManager.getInstance().getUserAvatar(), userAvatarView, R.drawable.ease_default_avatar);

        } else {
//            EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
//            EaseUserUtils.setUserNick(message.getFrom(), usernickView);
            usernickView.setAvatar(userAvatarView);
            ContactsCacheUtils.getInstance(context).loadText(message.getFrom(), usernickView);
        }
        ...
        if (bubbleLayout != null) {
            ...
            bubbleLayout.setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (itemClickListener != null) {
                        itemClickListener.onBubbleTouchEvent(event);
                    }
                    return false;
                }
            });
