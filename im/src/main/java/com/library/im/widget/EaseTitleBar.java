...
public class EaseTitleBar extends RelativeLayout{
    ...
    protected ImageView leftImage,arrowImage;
    protected RelativeLayout rightLayout;
    protected ImageView rightImage;
    protected LinearLayout arrowLayout;
    protected RecycleTextView titleView;
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        titleView = (RecycleTextView) findViewById(R.id.title);
        titleLayout = (LinearLayout) findViewById(R.id.root);
        arrowImage = (ImageView) findViewById(R.id.arrow);
        arrowLayout = (LinearLayout) findViewById(R.id.arrow_layout);
    ...
    public void setArrowVisibility(int visibility){arrowImage.setVisibility(visibility);}

    public void setArrowListener(OnClickListener listener){arrowLayout.setOnClickListener(listener);}
    
    public void setTitle(String title){
        titleView.setText(title);
    }

    public RecycleTextView getTitle(){
        return titleView;
    }
