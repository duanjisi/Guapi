package com.library.im.controller;
...
import com.ewuapp.framework.common.utils.StringUtil;
...
import com.library.im.db.DemoDBManager;
...
import com.library.im.model.EaseNotifier;
...
//import com.library.im.receiver.CallReceiver;
//import com.library.im.ui.VideoCallActivity;
//import com.library.im.ui.VoiceCallActivity;
...
public class HxHelper {
    ...
    public static boolean isMainActivityRun = true;
    ...
    Class chatClass, mainClass, detailClass;
     ...
     */
    public void init(Context context, Class chatClass, Class mainClass, Class detailClass) {
        ...
        ContactsCacheUtils.getInstance(context);
    }
    ...
    private EMOptions initChatOptions() {
        ...
        options.setMipushConfig("2882303761517480329", "5641748089329");
        //集成华为推送时需要设置
...
//                } else {
                intent = new Intent(appContext, chatClass);
...
//            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_CHANAGED));
        ...
        public void onAutoAcceptInvitationFromGroup(String groupId, String inviter, String inviteMessage) {
            ...
            msg.setTo(groupId);
            msg.setMsgId(UUID.randomUUID().toString());
            if (inviter != null && getUserInfo(inviter) != null && getUserInfo(inviter).getNick() != null) {
...
//            Hawk.put(Constant.ACCOUNT_REMOVED,true);
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    broadcastManager.sendBroadcast(new Intent(HXHELPER_ON_MESSAGE_RECEIVED));
                }
            }
     ...
     */
    public void logout(Context context, boolean unbindDeviceToken, final EMCallBack callback) {
        if (appContext == null) {
...
//    }
    ...
    synchronized void reset(Context context) {
        ...
        setContactList(null);
        setRobotList(null);
        DemoDBManager.getInstance(context).closeDB();
    }
    ...
    public void login(final String userName, String passwd, final CallBack callBack) {
        if (isLoggedIn()) {
            try {
                EMClient.getInstance().groupManager().loadAllGroups();
                EMClient.getInstance().chatManager().loadAllConversations();
                callBack.callBack(true);
                ContactsCacheUtils.getInstance(appContext).setOwner(userName);
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public void startActivity(Context context, String id) {
        Intent intent = new Intent(context, detailClass);
        Bundle bundle = new Bundle();
        bundle.putLong("id", StringUtil.toLong(id));
     ...
     * 退出登录,清空数据
     */
    public void logout(Context context, EMCallBack callBack) {
