...
import com.library.im.ChatListener;
...
import com.library.im.widget.EaseAlertDialog;
import com.library.im.widget.EaseAlertDialog.AlertDialogUser;
import com.library.im.widget.EaseChatExtendMenu;
import com.library.im.widget.EaseChatInputMenu;
import com.library.im.widget.EaseChatMessageList;
import com.library.im.widget.EaseVoiceRecorderView;
...
public class EaseChatFragment extends EaseBaseFragment {
    ...
    protected static final int REQUEST_CODE_VEDIO = 4;
    ...
    protected int[] itemdrawables = {R.drawable.img_images, R.drawable.img_camera};
    //    protected int[] itemdrawables = {R.drawable.img_favor, R.drawable.img_images,
//            R.drawable.img_sxt};
    protected int[] itemIds = {ITEM_PICTURE, ITEM_TAKE_PICTURE, ITEM_VEDIO};
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        isHideTitle = fragmentArgs.getBoolean("hide");
    ...
    protected void initView() {
        ...
        search = (RelativeLayout) getView().findViewById(R.id.query);
        search.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), MsgSearchActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("hid", toChatUsername);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) { // 单聊
            ...
            //}
            titleBar.setRightImageResource(R.drawable.nav_tongxun);
            titleBar.setArrowVisibility(View.GONE);
            titleBar.setRightLayoutVisibility(View.INVISIBLE);

            if (isHideTitle) {
                titleBar.setVisibility(View.GONE);
            }
            ContactsCacheUtils.getInstance(getActivity()).loadText(toChatUsername, titleBar.getTitle());
        } else {
            titleBar.setVisibility(View.GONE);
            titleBar.setRightImageResource(R.drawable.nav_tongxun);
            if (chatType == EaseConstant.CHATTYPE_GROUP) {
                ...
                titleBar.setArrowVisibility(View.VISIBLE);
            } else {
                onChatRoomViewCreation();
            }
            EMGroup group = EMClient.getInstance().groupManager().getGroup(toChatUsername);
            if (group != null) {
                ContactsCacheUtils.getInstance(getActivity()).loadText(group.getGroupName(), titleBar.getTitle());
            }
        }
            ...
            public void onClick(View v) {
                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
                    if (chatListener != null) {
                        chatListener.sigle(toChatUsername);
                    }
                } else {
                    if (chatListener != null) {
                        chatListener.group(toChatUsername);
                    }
                }
            }
        });
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onBubbleTouchEvent(MotionEvent event) {
                if (chatFragmentListener != null) {
                    chatFragmentListener.onBubbleTouchEvent(event);
                }
            }

            @Override
            public void onResendClick(final EMMessage message) {
                showMessageOKCancel(getString(R.string.confirm_resend), new DialogInterface.OnClickListener() {
                    @Override
...
//                new AlertView(getString(R.string.resend), getString(R.string.confirm_resend), "取消", new String[]{"确定"}, null, getActivity(),
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_LOCATION: // 位置
                    ...
                    break;
                case ITEM_VEDIO:
//                    startActivityForResult(new Intent(getActivity(), RecorderVideoActivity.class), REQUEST_CODE_VEDIO);
                    break;
                default:
                    break;
            }
    ...
    protected void sendTextMessage(String content) {
        ...
        message.setAttribute("uid", PreferenceManager.getInstance().getUserUId());
        sendMessage(message);
    }
    ...
    public static interface EaseChatFragmentListener {
        /**
         * 设置消息扩展属性
         */
         ...
         * 消息气泡框触摸事件
         */
        void onBubbleTouchEvent(MotionEvent event);
    }
