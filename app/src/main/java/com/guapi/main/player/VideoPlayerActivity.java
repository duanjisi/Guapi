...
import com.guapi.services.VideoCacheService;
import com.guapi.tool.FileUtils;
import com.guapi.widget.scan.ActionSheet;
 ...
 */
public class VideoPlayerActivity extends BaseActivity implements ActionSheet.OnSheetItemClickListener {
    private View view;
...
//                }
    ...
    private void showActionSheet() {
        actionSheet = new ActionSheet(VideoPlayerActivity.this)
                .builder()
                .setCancelable(false)
