...
public class CheckUtil {
    ...
    public static boolean checkMapAppExists(Context context, String packageName) {
//        return new File("/data/data/" + packageName).exists();
    ...
    //监测手机上安装了高德 百度地图中的几个？
    public static List<String> checkMapAppBumber(Context context) {
        List<String> stringList = new ArrayList<>();
        if (checkMapAppExists(context,"com.autonavi.minimap")) {
            stringList.add("高德地图");
        }
        if (checkMapAppExists(context,"com.baidu.BaiduMap")) {
            stringList.add("百度地图");
        }
        return stringList;
    }
