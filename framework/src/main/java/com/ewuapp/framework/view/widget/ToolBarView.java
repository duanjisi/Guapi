...
import com.ewuapp.framework.common.utils.TextViewUtil;
...
public class ToolBarView extends LinearLayout {
    ...
    private void showStyle(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            titleColor = style.getColor(R.styleable.ToolBarView_textColorTitle, Color.parseColor("#3d4246"));
            rightColor = style.getColor(R.styleable.ToolBarView_textColorRight, Color.parseColor("#3d4246"));
            ...
            rightTextSize = style.getDimension(R.styleable.ToolBarView_textSizeRight, 16);
    ...
    public void setBackPressed(final Activity activity) {
        setBackPressed(activity, R.drawable.ic_back);
    }
