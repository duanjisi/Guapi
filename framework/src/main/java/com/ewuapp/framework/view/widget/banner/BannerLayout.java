package com.ewuapp.framework.view.widget.banner;
...
//        tvContent.setText(contents.get(position));
        ...
        if (defaultImage != 0) {
            GlideUtil.loadPicture(url,imageView,defaultImage);
        } else {
            GlideUtil.loadPicture(url,imageView);
        }
        return view;
    }
        ...
        pager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (onPageSelectedListener != null) {
                    onPageSelectedListener.onPageSelected(position % itemCount);
                }
            }
        });
        startAutoPlay();
